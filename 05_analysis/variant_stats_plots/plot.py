...
#   plot-vcfstats SRR35784662_stats.txt -p variant_stats_plots/
#
# Edit as necessary and recreate the plots by running
#   python3 plot.py
#
# Title abbreviations:
# 	 0 .. SRR35 .. SRR35784662_filtered.vcf.gz
#
...
if 0 in dat and len(dat[0])>2:
    ax1.plot([row[0] for row in dat[0]], [row[1] for row in dat[0]], '-o',markersize=3, color='orange',mec='orange',label='SRR35')
    has_data = 1
